...
function CreateJobs() {
   ...
   const data1 = {...offer}      
    ...
    const submitHandler = async (e) => {
        e.preventDefault();
        await axios.post(`https://ats-be-n81k.onrender.com/api/v1/offer/createpdf`, data1) //create pdf next => get pdf
                .then((res) => 
                    axios.get(`https://ats-be-n81k.onrender.com/api/v1/offer/fetchpdf`, {responseType:'blob'})//to fetch the generate pdf
                    .then((res)=>{
                    ...
                    .then(()=>
                        ...
                        axios.post(`https://ats-be-n81k.onrender.com/api/v1/offer/sendpdf`, {email: offer.email, joiningDate: offer.date, position: offer.title, name: offer.applicantname})
                        .then(res => {
                            console.log(res)
                            alert(res.data)
        ...
        try {
            ...
            const res = await axios.post(`https://ats-be-n81k.onrender.com/api/v1/offer/createoffer`, newoffer, {
                headers: {
