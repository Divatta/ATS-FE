...
function EditJobs() {
    ...
    const getSingleProduct = async() => {
      const res = await axios.get(`https://ats-be-n81k.onrender.com/api/v1/offer/single/${params.id}`)
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            const res = await axios.patch(`https://ats-be-n81k.onrender.com/api/v1/offer/updateoffer/${params.id}`, newoffer, {
                headers: {
