...
function ManageJobs() {
  ...
  const getOffers = async()=>{
    const res = await axios.get(`https://ats-be-n81k.onrender.com/api/v1/offer/all`)
  ...
  const deleteoffer = async (id)=>{
    if(window.confirm(`Are you sure to delete job?`)) {
        await axios.delete(`https://ats-be-n81k.onrender.com/api/v1/offer/deleteoffer/${id}`, {
          headers : {
...
<div className="container">
  ...
  <div className="row">
    ...
    <h5 className="text-success mb-2 mt-3">Offer OnBoard</h5>
