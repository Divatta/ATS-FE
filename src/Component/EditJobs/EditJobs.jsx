...
function EditJobs() {
    ...
    const getSingleProduct = async() => {
      const res = await axios.get(`https://ats-be-n81k.onrender.com/api/v1/jobs/single/${params.id}`)
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            const res = await axios.patch(`https://ats-be-n81k.onrender.com/api/v1/jobs/update/${params.id}`, newjob, {
                headers: {
        ...
        <div className="container h-100">
          <div className="row d-flex justify-content-center align-items-center h-100">
            <div className="col-xl-9">
              <h5 className="text-success mb-2">Update Job</h5>
              <form className='shadow-lg mb-5 rounded ' autoComplete='off' onSubmit={submitHandler} >
                        <div className="card bg-light pt-4 px-4">
                            ...
                            <div className="row  py-3">
                                ...
                                <textarea  maxlength="250" className="form-control"  cols="30" rows="5"  placeholder="Message sent to the employer" name="desc" id='desc' value={job.desc} onChange={readValue} required></textarea>
                            ...
                            <div className="row  py-3">
                                ...
                                <textarea  maxlength="250" className="form-control"  cols="30" rows="6"  placeholder="Message sent to the employer" value={job.resp} name='resp' id='resp' onChange={readValue} required></textarea>
                            ...
                            <div className="px-5 text-center py-4">
                                <button type="submit" className="btn btn-outline-success btn-lg">Update Job</button>
                            </div>
